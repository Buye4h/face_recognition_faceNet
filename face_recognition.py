...
video= "./video/Rose_test.mp4" #ใส่ video, webcam
                        ...
                        if best_class_probabilities>0.87:
                            ...
                            for H_i in HumanNames:
                                if HumanNames[best_class_indices[0]] == H_i:
                                    ...
                                    percents = round(best_class_probabilities[0]*100,2)
                                    font = cv2.FONT_HERSHEY_COMPLEX_SMALL
                                    print("Predictions : [ name: {} , accuracy: {:.3f} ]".format(HumanNames[best_class_indices[0]],best_class_probabilities[0]))
                                    cv2.rectangle(frame, (xmin, ymin-20), (xmax, ymin-2), (0, 255,255), -1)
                                    cv2.putText(frame, result_names, (xmin,ymin-5), font, 1, (0, 0, 0), thickness=1, lineType=1)
                                    cv2.putText(frame, "MATCH: "+str(percents)+"%", (xmin+6, ymin+23), font, 0.9, (255,255,255), 1)
